        ...
        <ScrollView>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {recommended?.map((item, index) => (
                    <View key={index} style={{
                        backgroundColor: "white", margin: 10, flexDirection: "row",
                        borderRadius: 8
                    }}>
                        <View>
                        ...
                        <View style={{ padding: 10, flexDirection: "column" }}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", gap: 3 }}>
                                <AntDesign name="clockcircle" color="green" size={24} />
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {items?.map((item, index) => (
                    <View key={index} style={{
                        width: 95, borderColor: "#E0E0E0", borderWidth: 1, paddingVertical: 5, paddingHorizontal: 1, borderRadius: 5, marginLeft: 10, marginVertical: 10,
            ...
            <Text style={{ textAlign: "center", marginTop: 7, letterSpacing: 4, textAlign: "center" }}>ALL RESTURANTS</Text>
